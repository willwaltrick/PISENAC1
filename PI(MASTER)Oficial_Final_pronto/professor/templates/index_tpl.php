...
<html lang="en">
  <head>
    ...
    <link href="../../assets/css/ie10-viewsport-bug-workaround.css" rel="stylesheet">
...
br {
  ...
  <?php
          ...
          <th class="text-center">ID Senac</th>
          <th class="text-center">Tipo</th>
				...
				foreach($professors as $cod => $professor){
					echo "	<tr>
								...
								<td class='text-center'>{$professor['idSenac']}</td>
								<td class='text-center'>{$professor['tipo']}</td>
		...
		<form method="post">
					...
					<label for="senha">Senha:</label><input type="password"
										name="senha"><br>
					<label for="idsenac">Idsenac:</label><input type="number"
										name="idSenac"><br>
