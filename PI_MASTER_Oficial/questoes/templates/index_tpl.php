...
@media(min-width:768px) {
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="index.html" class="p">Área</a></li>
                    <li><a href="index.html" class="p">Assunto</a></li>
                    <li><a href="index.html" class="p">Professor</a></li>
                    <li><a href="index.html" class="p">Questão</a></li>
                    <li><a href="sobre.html" class="p">Sair</a></li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        </div>
  ...
  <?php
			...
			<table border="1">
				...
				<?php
				foreach($questaos as $cod => $questao){
					echo "	<tr>
								<td>$cod</td>
		...
		<form method="post">
					...
					Texto Questão: <input type="text"
										name="professor">
				</p>
                <p>
					CodAssunto: <input type="text"
										name="email">
				</p>
                <p>
					CodImagem: <input type="password"
										name="senha">
				</p>
                <p>
					CodProfessor: <input type="text"
										name="idSenac">
