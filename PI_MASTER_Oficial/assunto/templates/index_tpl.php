        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="galeria.html" class="p">Questão</a></li>
    ...
    <div class="col-md-12">
         <br><br>
  		<?php
			...
			<table border="1">
				<tr>
					<th>C&oacute;digo do Assunto</th>
					<th>Descri&ccedil;&atilde;o Assunto</th>
          <th>C&oacute;digo da &Aacute;rea</th>
					<th>Editar</th>
					<th>Apagar</th>
				</tr>
				<?php
				...
				foreach($assuntos as $cod => $assunto){
		...
		<form method="post">
				<p>
					Escolha: <select name="selectarea">
						<?php
