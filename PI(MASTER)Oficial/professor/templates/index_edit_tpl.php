...
br {
  ...
  <body>
    ...
    <!-- Second Featurette -->
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-header">Professor
                	<small>editar</small></h1>
                <ol class="breadcrumb">
                    <li><a href="../index.php">Home</a>
                    </li>
                    <li class="active"><a href="index.php">Professor</a></li>
		...
		<div>
			<form method="post">
				...
				<label for="senha">Senha:</label>
					       <input type="password"
										name="senha"><br>
				<label for="IdSenac">IdSenac:</label>
					       <input type="text"
										name="idSenac"
										value="<?php echo $idSenac; ?>"><br>
	      <label for="tipo">Tipo:</label>
					       <input type="text"
										name="tipo"
										value="<?php echo $tipo; ?>"><br>
