        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="../index.php">Questões</a></li>
        ...
        <section id="editAssunto">
            <div class="container">
                <form class="form-group" action="questoes.php" method="post">
                    <label>Questão:</label>
                    <input class="" type="text" name="idQuestao" spellcheck="5" value="<?php echo $_GET['edit'] ?>" hidden><br>
                    <p><input type="text" name="newQuestao" value="<?php echo $_GET['oldQuestao'] ?>"><p><br>
                    <p><select name="newAssunto">
                    ...
                    <p><select name="newAtivo">
                        <option value="1">1</option>
                        <option value="0">0</option>
                    </select></p>
                    <p><select name="newDificuldade">
